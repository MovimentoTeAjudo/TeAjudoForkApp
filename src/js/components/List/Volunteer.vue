  ...
  <div class="">
    <div class="row no-gutters align-items-center" slot="header">
      ...
      <div class="col-8">
        ...
        <small v-if="item.options && item.options.psicologo && item.options.document"> {{item.options.document}} <img  src="/images/verified.png" width="16" height="16" alt=""></small>
      </div>
    ...
    <div class="info">
      <div class="type">
        <div>
          <div class="help-with" v-text="$ml.get('home.map.popup.help_with')"></div>
          ...
          <span class="tag" v-if="item.options.health">
          ...
          <span class="tag" v-if="item.options.dog">
