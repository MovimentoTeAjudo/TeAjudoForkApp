<template>
  <div class="">
    <div class="row no-gutters" slot="header">
      <div class="col-2">
        <img v-if="item.type == 'store' && item.options && !item.options.blood" src="/images/movimento/abrigo.png" width="32" height="32" alt="">
        <img v-else src="/images/movimento/sangue.png" width="32" height="32" alt="">
      </div>
      <div class="col-8">
        <h3>
          {{item.name}}
    ...
    <div class="info">
      <div class="type">
        ...
        <span class="tag" v-if="item.options.market">
          ...
          <small>Central de Arrecadação</small>
        </span>
        <div v-if="item.options.others">
          <hr>
          <span class="tag" v-text="item.options.others"></span>
        </div>
        <span class="tag" v-if="item.options.available && item.options.available.delivery">
          ...
          <small>Recebemos via drive-thru</small>
        </span>
      </div>
